  ...
  return (
    <div className="min-h-screen p-6 flex flex-col items-center justify-center">
      <div className="max-w-2xl w-full">
        <Badge className="mb-4 px-4 py-2 bg-gradient-meditate text-white">Avoiding Brainrot</Badge>
        <Card className="mb-8">
          <CardHeader>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            ...
            <Button size="sm" variant="outline" onClick={() => setSuggestion(getRandomFavourite())}>New Suggestion</Button>
          </CardContent>
        </Card>
        <Card>
          <CardHeader>
